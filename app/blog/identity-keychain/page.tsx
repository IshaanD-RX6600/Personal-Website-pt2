    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-24 pb-40">
        <div className="mb-10">
          ...
          <p className="text-gray-300 text-base leading-relaxed max-w-2xl">A reflective exploration of how the colors and patterns of a handmade keychain map to layered identity, emotion, grief, growth, and community.</p>
        </div>
